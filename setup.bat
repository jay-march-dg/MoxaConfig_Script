...
echo     python upload_moxa.py DEVICE_NAME [options]
echo.
echo   GUI Mode (interactive interface):
echo     python moxa_gui.py
echo.
echo   For help:
echo     python upload_moxa.py --help
echo.
echo Example devices from deviceList.csv:
echo   python upload_moxa.py 1A-RIO-SDT-06A-1
echo   python upload_moxa.py 1A-RIO-SDT-06A-1 --dry-run
echo.
pause
